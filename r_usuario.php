    ...
    <div class="full">
        <div class="container">
            ...
            <form action="registrar.php" method="post">
                ...
                <div class="form-group">
                    <input type="password" placeholder="8 - 20" name="contrasena" id="contrasena" required minlength="8"
                        maxlength="20">
                    <label for="password">Contraseña</label>
                </div>
                <div class="form-group">
                    <input type="password" placeholder=" " name="confirmar_contra" id="confirmar_contra" required
